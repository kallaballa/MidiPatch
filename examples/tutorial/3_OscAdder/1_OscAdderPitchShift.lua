...
having a slightly different pitch. It demonstrates how through
scripting synthesizers can be created that are hard to create
with traditional paradigmes.
]]--
...
synth:setOutputGen(mix * velocity * env * volume);
